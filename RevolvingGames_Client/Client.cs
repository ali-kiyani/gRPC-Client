...
namespace RevolvingGames_Client
{
    public class Client
    {
        ...
        public Client() 
        {
            ...
            channel = GrpcChannel.ForAddress("https://localhost:7118");
        ...
        private async Task Receive()
        {
            ...
            {
                //Console.WriteLine("Received from server: " + response.ToString() + " within " + (DateTimeOffset.Now.ToUnixTimeMilliseconds() - rrt.GetValueOrDefault(response.Id)) + " milliseconds");
